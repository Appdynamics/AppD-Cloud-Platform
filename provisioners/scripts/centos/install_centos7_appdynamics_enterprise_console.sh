...
appd_platform_release="${appd_platform_release:-20.7.3.22924}"
appd_platform_sha256="${appd_platform_sha256:-f6ec535547c1730140fda8c0936a138b4f1b3bc0bf96ea35386ce46f59435b0e}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_platform_release="20.7.3.22924"                 # [optional] platform release (defaults to '20.7.3.22924').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_platform_sha256="f6ec535547c1730140fda8c0936a138b4f1b3bc0bf96ea35386ce46f59435b0e"
