...
appd_platform_release="${appd_platform_release:-21.4.19.24836}"
appd_platform_sha256="${appd_platform_sha256:-b8cf84adb21027d89ab1331eba208e3ba5a7c5bf190dfc2c58b0b84b22aa2c44}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_platform_release="21.4.19.24836"                # [optional] platform release (defaults to '21.4.19.24836').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_platform_sha256="b8cf84adb21027d89ab1331eba208e3ba5a7c5bf190dfc2c58b0b84b22aa2c44"
