...
appd_platform_release="${appd_platform_release:-21.4.18.24828}"
appd_platform_sha256="${appd_platform_sha256:-3faf23fa1861807b5459d99079e510a2bbf81d72c315895fdedccc8421840aee}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_platform_release="21.4.18.24828"                # [optional] platform release (defaults to '21.4.18.24828').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_platform_sha256="3faf23fa1861807b5459d99079e510a2bbf81d72c315895fdedccc8421840aee"
