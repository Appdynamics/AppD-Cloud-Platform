...
appd_platform_release="${appd_platform_release:-21.4.13.24717}"
appd_platform_sha256="${appd_platform_sha256:-143d093db0b7837fbb19f3ac5f8bdf9e61249f7457382b71bce7aac0b93b5137}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_platform_release="21.4.13.24717"                # [optional] platform release (defaults to '21.4.13.24717').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_platform_sha256="143d093db0b7837fbb19f3ac5f8bdf9e61249f7457382b71bce7aac0b93b5137"
