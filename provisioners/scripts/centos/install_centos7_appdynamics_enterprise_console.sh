...
appd_platform_release="${appd_platform_release:-20.7.0.22903}"
appd_platform_sha256="${appd_platform_sha256:-4f5076937d7d0a0036f80662ee282521e6b3ab1b14816640dd7def1af717da8b}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_platform_release="20.7.0.22903"                 # [optional] platform release (defaults to '20.7.0.22903').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_platform_sha256="4f5076937d7d0a0036f80662ee282521e6b3ab1b14816640dd7def1af717da8b"
