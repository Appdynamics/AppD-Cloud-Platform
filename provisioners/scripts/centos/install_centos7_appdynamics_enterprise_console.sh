...
appd_platform_release="${appd_platform_release:-20.8.3.23251}"
appd_platform_sha256="${appd_platform_sha256:-f16e39dda5f721c271951aa4c7b36bfb41b2b2e7051dfcf8e142400c395293c0}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_platform_release="20.8.3.23251"                 # [optional] platform release (defaults to '20.8.3.23251').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_platform_sha256="f16e39dda5f721c271951aa4c7b36bfb41b2b2e7051dfcf8e142400c395293c0"
