...
appd_eum_server_release="${appd_eum_server_release:-21.4.2.34145}"
appd_eum_server_sha256="${appd_eum_server_sha256:-ce66c98038752be9102b494bd8e9fc7a87068331d0fd102cc4bf6af1bf16cecc}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_eum_server_release="21.4.2.34145"               # [optional] platform release (defaults to '21.4.2.34145').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_eum_server_sha256="ce66c98038752be9102b494bd8e9fc7a87068331d0fd102cc4bf6af1bf16cecc"
