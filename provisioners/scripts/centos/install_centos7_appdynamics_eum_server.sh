...
appd_eum_server_release="${appd_eum_server_release:-20.6.1.31662}"
appd_eum_server_sha256="${appd_eum_server_sha256:-af497347d1d4f1ffcd69b33f60c6fc438e2c177a5ea0e8af45246eb62accd336}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_eum_server_release="20.6.5.22646"                 # [optional] platform release (defaults to '20.6.5.22646').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_eum_server_sha256="fe6950252bfc63b19e0a5c838b0c9bdb7a986cd4a7d3f3b0e61e551ff4e8c5c4"
