...
appd_eum_server_release="${appd_eum_server_release:-21.4.0.32860}"
appd_eum_server_sha256="${appd_eum_server_sha256:-a2b42b669747d9c94fd9b59df5f9802a3d8ac3b16904b97ef7bd7e80ab74dc2e}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_eum_server_release="21.4.0.32860"               # [optional] platform release (defaults to '21.4.0.32860').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_eum_server_sha256="a2b42b669747d9c94fd9b59df5f9802a3d8ac3b16904b97ef7bd7e80ab74dc2e"
