...
appd_machine_agent_release="${appd_machine_agent_release:-23.8.0.3716}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-a373ecf8d8501ebcd0d52bce187529aee30282cc95daf4c815ed686dfbc887dd}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="23.8.0.3716"             # [optional] machine agent release (defaults to '23.8.0.3716').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root]# export appd_machine_agent_sha256="a373ecf8d8501ebcd0d52bce187529aee30282cc95daf4c815ed686dfbc887dd"
