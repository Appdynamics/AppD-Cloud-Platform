...
#   aws s3 cp license-apm-any-language-expires-2020-12-18.lic s3://appd-cloud-kickstart-tools/apm-platform/
#   aws s3 rm s3://appd-cloud-kickstart-tools/apm-platform/license-apm-any-language-expires-2020-12-18.lic
#
...
appd_license_expiration="${appd_license_expiration:-2020-12-18}"
