...
appd_platform_name="${appd_platform_name-AppDynamics Cloud Platform}"
appd_project_image_types="${appd_project_image_types-AppD-Cloud-Platform-CentOS7 AppD-Cloud-Platform-HA-CentOS7}"
