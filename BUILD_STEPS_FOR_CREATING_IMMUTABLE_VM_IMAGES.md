...
2.	Install the [Homebrew 3.2.17](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    `$ /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install.sh)"`

3.	Install [Packer 1.7.7](https://packer.io/) for macOS 64-bit.  
    `$ brew install packer`  

4.	Install [Git 2.33.1](https://git-scm.com/downloads) for macOS 64-bit.  
    `$ brew install git`  
...
-	Packer 1.7.7
-	Git 2.33.1 for Win64
-	jq 1.6

Perform the following steps to install the needed software:

1.	Install [Packer 1.7.7](https://releases.hashicorp.com/packer/1.7.7/packer_1.7.7_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\Packer\bin`  

2.	Install [Git 2.33.1](https://github.com/git-for-windows/git/releases/download/v2.33.1.windows.1/Git-2.33.1-64-bit.exe) for Windows 64-bit.
