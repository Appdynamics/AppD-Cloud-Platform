...
4.	Install [Git 2.29.1](https://git-scm.com/downloads) for macOS 64-bit.  
    `$ brew install git`  
...
2.	Install [Git 2.29.1](https://github.com/git-for-windows/git/releases/download/v2.29.1.windows.1/Git-2.29.1-64-bit.exe) for Windows 64-bit.
