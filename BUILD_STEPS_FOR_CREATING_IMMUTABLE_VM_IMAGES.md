...
2.	Install the [Homebrew 3.2.10](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    `$ /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install.sh)"`

3.	Install [Packer 1.7.4](https://packer.io/) for macOS 64-bit.  
    `$ brew install packer`  
...
1.	Install [Packer 1.7.4](https://releases.hashicorp.com/packer/1.7.4/packer_1.7.4_windows_amd64.zip) for Windows 64-bit.  
