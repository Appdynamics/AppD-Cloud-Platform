...
2.	Install the [Homebrew 3.5.5](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    `$ /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install.sh)"`

3.	Install [Packer 1.8.2](https://packer.io/) for macOS 64-bit.  
    `$ brew install packer`  

4.	Install [Git 2.37.1](https://git-scm.com/downloads) for macOS 64-bit.  
    `$ brew install git`  
...
-	Packer 1.8.2
-	Git 2.37.1 for Win64
-	jq 1.6

Perform the following steps to install the needed software:

1.	Install [Packer 1.8.2](https://releases.hashicorp.com/packer/1.8.2/packer_1.8.2_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\Packer\bin`  

2.	Install [Git 2.37.1](https://github.com/git-for-windows/git/releases/download/v2.37.1.windows.1/Git-2.37.1-64-bit.exe) for Windows 64-bit.
