...
2.	Install the [Homebrew 3.6.4](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    `$ /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install.sh)"`

3.	Install [Packer 1.8.3](https://packer.io/) for macOS 64-bit.  
    `$ brew install packer`  

4.	Install [Git 2.38.0](https://git-scm.com/downloads) for macOS 64-bit.  
    `$ brew install git`  
...
2.	Install [Git 2.38.0](https://github.com/git-for-windows/git/releases/download/v2.38.0.windows.1/Git-2.38.0-64-bit.exe) for Windows 64-bit.
