...
4.	Install [Git 2.35.3](https://git-scm.com/downloads) for macOS 64-bit.  
    `$ brew install git`  
...
2.	Install [Git 2.35.3](https://github.com/git-for-windows/git/releases/download/v2.35.3.windows.1/Git-2.35.3-64-bit.exe) for Windows 64-bit.
