...
2.	Install the [Homebrew 4.0.28](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    `$ /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install.sh)"`

3.	Install [Packer 1.9.1](https://packer.io/) for macOS 64-bit.  
    `$ brew install packer`  
...
1.	Install [Packer 1.9.1](https://releases.hashicorp.com/packer/1.9.1/packer_1.9.1_windows_amd64.zip) for Windows 64-bit.  
