...
2.	Install the [Homebrew 3.2.0](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    `$ /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install.sh)"`

3.	Install [Packer 1.7.3](https://packer.io/) for macOS 64-bit.  
    `$ brew install packer`  

4.	Install [Git 2.32.0](https://git-scm.com/downloads) for macOS 64-bit.  
    `$ brew install git`  
...
1.	Install [Packer 1.7.3](https://releases.hashicorp.com/packer/1.7.3/packer_1.7.3_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\Packer\bin`  

2.	Install [Git 2.32.0](https://github.com/git-for-windows/git/releases/download/v2.32.0.windows.1/Git-2.32.0-64-bit.exe) for Windows 64-bit.
