...
2.	Install the [Homebrew 3.2.14](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
...
1.	Install [Packer 1.7.6](https://releases.hashicorp.com/packer/1.7.6/packer_1.7.6_windows_amd64.zip) for Windows 64-bit.  
