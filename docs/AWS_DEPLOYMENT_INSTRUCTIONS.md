...
-	Amazon AWS CLI 2.5.0 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.5.0](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    $ aws --version
    aws-cli/2.5.0 Python/3.9.10 Darwin/21.4.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.5.0](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```bash
    $ aws --version
    aws-cli/2.5.0 Python/3.8.8 Windows/10 exe/AMD64 prompt/off
    ```
...
-	AppDynamics Enterprise Console 21.4.13 Build 24717
	...
	-	AppDynamics EUM Server 21.4.3 Build 34447
-	Docker 20.10.14 CE
...
-	Python 3.6.8
	-	Pip 22.0.4
-	VIM - Vi IMproved 8.2
-	yq 4.24.2 (command-line YAML processor)
...
-	Amazon AWS CLI 2.5.0 (command-line interface)
-	Amazon AWS EC2 Instance Metadata Query Tool (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.89.0 (command-line interface)
...
-	npm JavaScript Package Manager for Node.js 8.5.5
-	nvm (Node Version Manager) bash script 0.39.1
-	Python 2.7.5
	-	Pip 22.0.4
-	Python 3.6.8
	-	Pip 22.0.4
-	Serverless Framework CLI 3.10.0
-	VIM - Vi IMproved 8.2
-	yq 4.24.2 (command-line YAML processor)
