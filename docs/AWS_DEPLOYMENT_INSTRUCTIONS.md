...
1.	Install [AWS CLI 2.2.13](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
1.	Install [AWS CLI 2.2.13](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
