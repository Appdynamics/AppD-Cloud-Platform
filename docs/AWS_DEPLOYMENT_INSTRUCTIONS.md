...
-	Amazon AWS CLI 2.8.10 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.8.10](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    $ aws --version
    aws-cli/2.8.10 Python/3.10.8 Darwin/21.6.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.8.10](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
