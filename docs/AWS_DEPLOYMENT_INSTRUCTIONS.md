...
1.	Install [AWS CLI 2.2.43](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    $ aws --version
    aws-cli/2.2.43 Python/3.9.7 Darwin/20.6.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.2.43](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
-	npm JavaScript Package Manager for Node.js 7.24.1
-	nvm (Node Version Manager) bash script 0.38.0
-	Python 2.7.5
	-	Pip 21.2.4
-	Python 3.6.8
	-	Pip 21.2.4
-	Serverless Framework CLI 2.60.3
-	VIM - Vi IMproved 8.2
-	yq 4.13.3 (command-line YAML processor)
