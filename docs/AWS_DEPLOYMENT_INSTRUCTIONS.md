...
-	Amazon AWS CLI 2.2.40 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.2.40](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    $ aws --version
    aws-cli/2.2.40 Python/3.9.7 Darwin/20.6.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.2.40](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```bash
    $ aws --version
    aws-cli/2.2.40 Python/3.8.8 Windows/10 exe/AMD64 prompt/off
    ```
...
-	Python 3.6.8
	-	Pip 21.2.4
-	VIM - Vi IMproved 8.2
-	yq 4.13.2 (command-line YAML processor)
...
-	Amazon AWS CLI 2.2.40 (command-line interface)
-	Amazon AWS EC2 Instance Metadata Query Tool (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.67.0 (command-line interface)
...
-	npm JavaScript Package Manager for Node.js 7.24.0
-	nvm (Node Version Manager) bash script 0.38.0
-	Python 2.7.5
	-	Pip 21.2.4
-	Python 3.6.8
	-	Pip 21.2.4
-	Serverless Framework CLI 2.59.0
-	VIM - Vi IMproved 8.2
-	yq 4.13.2 (command-line YAML processor)
