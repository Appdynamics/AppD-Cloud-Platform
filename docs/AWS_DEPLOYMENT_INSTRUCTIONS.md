...
-	Amazon AWS CLI 2.4.1 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.4.1](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    $ aws --version
    aws-cli/2.4.1 Python/3.9.9 Darwin/20.6.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.4.1](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
-	AppDynamics Enterprise Console 21.4.9 Build 24662
	...
	-	AppDynamics EUM Server 21.4.2 Build 34145
-	Docker 20.10.11 CE
...
-	Python 3.6.8
	-	Pip 21.3.1
-	VIM - Vi IMproved 8.2
-	yq 4.15.1 (command-line YAML processor)
...
-	Amazon AWS CLI 2.4.1 (command-line interface)
-	Amazon AWS EC2 Instance Metadata Query Tool (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.74.0 (command-line interface)
...
-	jq 1.6 (command-line JSON processor)
-	Node.js JavaScript runtime v16.13.0 (Latest LTS Version)
-	npm JavaScript Package Manager for Node.js 8.1.4
-	nvm (Node Version Manager) bash script 0.39.0
-	Python 2.7.5
	-	Pip 21.3.1
-	Python 3.6.8
	-	Pip 21.3.1
-	Serverless Framework CLI 2.66.2
-	VIM - Vi IMproved 8.2
-	yq 4.15.1 (command-line YAML processor)
