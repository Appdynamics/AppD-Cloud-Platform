...
-	Amazon AWS CLI 2.1.7 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.1.7](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
1.	Install [AWS CLI 2.1.7](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```bash
    $ aws --version
    aws-cli/2.1.7 Python/3.7.7 Windows/10 botocore/2.0.0dev74
    ```
...
-	Amazon AWS EC2 Instance Metadata Query Tool (command-line interface)
-	Ansible 2.9.15
-	Cisco Workload Optimization Manager (CWOM) 2.3.26
-	Docker 19.03.14 CE
	-	Docker Bash Completion
	-	Docker Compose 1.27.4
	-	Docker Compose Bash Completion
...
-	Amazon AWS CLI 2.1.7 (command-line interface)
-	Amazon AWS EC2 Instance Metadata Query Tool (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.33.0 (command-line interface)
...
-	npm JavaScript Package Manager for Node.js 7.1.0
