...
-	Amazon AWS CLI 2.2.6 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.2.6](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    $ aws --version
    aws-cli/2.2.6 Python/3.9.5 Darwin/20.4.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.2.6](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```bash
    $ aws --version
    aws-cli/2.2.6 Python/3.8.8 Windows/10 exe/AMD64 prompt/off
    ```
...
-	Amazon AWS CLI 2.2.6 (command-line interface)
-	Amazon AWS EC2 Instance Metadata Query Tool (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.51.0 (command-line interface)
-	Amazon AWS Kubernetes Control CLI [kubectl] 1.20.4 (command-line interface)
-	Ansible 2.9.22
-	AppDynamics Node.js Serverless Tracer 21.5.286
-	Docker 20.10.6 CE
	-	Docker Bash Completion
	-	Docker Compose 1.29.2
	-	Docker Compose Bash Completion
...
-	Python 3.6.8
	-	Pip 21.1.2
-	Serverless Framework CLI 2.43.1
-	VIM - Vi IMproved 8.2
-	yq 4.9.3 (command-line YAML processor)
