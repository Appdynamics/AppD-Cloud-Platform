...
-	Amazon AWS CLI 2.7.14 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.7.14](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    $ aws --version
    aws-cli/2.7.14 Python/3.10.5 Darwin/21.5.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.7.14](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```bash
    $ aws --version
    aws-cli/2.7.14 Python/3.9.11 Windows/10 exe/AMD64 prompt/off
    ```
...
-	Python 3.6.8
	-	Pip 22.1.2
-	Serverless Framework CLI 3.20.0
-	VIM - Vi IMproved 9.0
-	yq 4.25.3 (command-line YAML processor)
