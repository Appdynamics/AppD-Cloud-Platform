...
-	Amazon AWS CLI 2.7.16 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.7.16](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    $ aws --version
    aws-cli/2.7.16 Python/3.10.5 Darwin/21.5.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.7.16](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
-	Amazon AWS CLI 2.7.16 (command-line interface)
-	Amazon AWS EC2 Instance Metadata Query Tool (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.105.0 (command-line interface)
...
-	Helm CLI 3.9.1 (Package Manager for Kubernetes)
-	Java SE JDK 8 Update 332 (Amazon Corretto 8)
-	Java SE JDK 11.0.15 (Amazon Corretto 11)
-	Java SE JDK 17.0.3 (Amazon Corretto 17)
-	Java SE JDK 18.0.1 (Amazon Corretto 18)
-	jq 1.6 (command-line JSON processor)
-	Node.js JavaScript runtime v16.16.0 (Latest LTS Version)
-	npm JavaScript Package Manager for Node.js 8.14.0
-	nvm (Node Version Manager) bash script 0.39.1
-	Python 2.7.5
	-	Pip 22.1.2
-	Python 3.6.8
	-	Pip 22.1.2
-	Serverless Framework CLI 3.21.0
-	VIM - Vi IMproved 9.0
-	yq 4.26.1 (command-line YAML processor)
