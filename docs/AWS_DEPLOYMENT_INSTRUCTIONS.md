...
-	Amazon AWS CLI 2.2.45 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.2.45](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    $ aws --version
    aws-cli/2.2.45 Python/3.9.7 Darwin/20.6.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.2.45](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
