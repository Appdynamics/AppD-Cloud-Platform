...
-	Amazon AWS CLI 2.3.0 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.3.0](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    $ aws --version
    aws-cli/2.3.0 Python/3.9.7 Darwin/20.6.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.3.0](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
-	Python 3.6.8
	-	Pip 21.3.1
-	VIM - Vi IMproved 8.2
-	yq 4.13.5 (command-line YAML processor)
...
-	Amazon AWS CLI 2.3.0 (command-line interface)
-	Amazon AWS EC2 Instance Metadata Query Tool (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.70.0 (command-line interface)
...
-	npm JavaScript Package Manager for Node.js 8.1.1
-	nvm (Node Version Manager) bash script 0.39.0
-	Python 2.7.5
	-	Pip 21.3.1
-	Python 3.6.8
	-	Pip 21.3.1
-	Serverless Framework CLI 2.64.1
-	VIM - Vi IMproved 8.2
-	yq 4.13.5 (command-line YAML processor)
