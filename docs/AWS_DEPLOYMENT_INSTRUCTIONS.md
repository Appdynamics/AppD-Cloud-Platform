...
-	Amazon AWS CLI 2.1.22 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.1.22](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
1.	Install [AWS CLI 2.1.22](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
-	Helm CLI 3.5.1 (Package Manager for Kubernetes)
-	Java SE JDK 8 Update 282 (Amazon Corretto 8)
...
-	npm JavaScript Package Manager for Node.js 7.5.0
-	nvm (Node Version Manager) bash script 0.37.2
-	Python 2.7.5
	-	Pip 21.0.1
-	Python 3.6.8
	-	Pip 21.0.1
-	Serverless Framework CLI 2.21.1
-	VIM - Vi IMproved 8.2
