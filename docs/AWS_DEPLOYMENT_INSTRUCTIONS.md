...
-	Amazon AWS CLI 2.1.24 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.1.24](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    $ aws --version
    aws-cli/2.1.24 Python/3.9.1 Darwin/19.6.0 source/x86_64 prompt/off
    ```
...
1.	Install [AWS CLI 2.1.24](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```bash
    $ aws --version
    aws-cli/2.1.24 Python/3.7.9 Windows/10 exe/AMD64 prompt/off
    ```
...
-	Helm CLI 3.5.2 (Package Manager for Kubernetes)
-	Java SE JDK 8 Update 282 (Amazon Corretto 8)
-	Java SE JDK 11.0.10 (Amazon Corretto 11)
-	Java SE JDK 15.0.2 (Amazon Corretto 15)
-	jq 1.6 (command-line JSON processor)
-	Node.js JavaScript runtime v14.15.5 (Latest LTS Version)
-	npm JavaScript Package Manager for Node.js 7.5.3
