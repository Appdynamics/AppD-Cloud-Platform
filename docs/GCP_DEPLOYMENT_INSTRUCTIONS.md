...
-	__AppD-Cloud-Platform-HA VM__: A stand-alone VM with an AppDynamics Cloud Platform 21.4.5 HA configuration on CentOS 7.9.
...
-	Google Cloud SDK 355.0.0 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [Google Cloud SDK 355.0.0](https://cloud.google.com/sdk/docs/install#mac) for macOS 64-bit.  
    ```bash
    $ brew cask install google-cloud-sdk
    ```
