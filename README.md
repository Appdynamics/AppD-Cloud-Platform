...
1.	Install the [Homebrew 4.0.20](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    ```bash
...
3.	Install [Packer 1.8.7](https://www.packer.io/downloads.html) for macOS 64-bit.  
    ```bash
...
5.	Install [Ansible 7.6.0](https://ansible.com/) for macOS 64-bit.  
    ```bash
