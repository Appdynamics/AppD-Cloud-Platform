...
1.	Install the [Homebrew 4.0.26](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    ```bash
...
3.	Install [Packer 1.9.1](https://www.packer.io/downloads.html) for macOS 64-bit.  
    ```bash
