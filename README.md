...
1.	Install the [Homebrew 3.4.0](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    ```bash
...
5.	Install [Ansible 5.3.0](https://ansible.com/) for macOS 64-bit.  
    ```bash
