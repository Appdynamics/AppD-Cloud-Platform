...
1.	Install the [Homebrew 2.7.7](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    ```bash
...
5.	Install [Ansible 2.10.6](https://ansible.com/) for macOS 64-bit.  
    ```bash
