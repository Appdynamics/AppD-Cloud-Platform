...
1.	Install the [Homebrew 3.1.6](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    ```bash
...
5.	Install [Ansible 3.3.0](https://ansible.com/) for macOS 64-bit.  
    ```bash
