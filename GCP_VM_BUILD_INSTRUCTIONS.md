...
-	Amazon AWS CLI 2.0.54 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.0.54](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
1.	Install [AWS CLI 2.0.54](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```
    $ aws --version
    aws-cli/2.0.54 Python/3.7.7 Windows/10 botocore/2.0.0dev58
    ```
...
-	Ansible 2.9.14
-	AppDynamics Enterprise Console 20.10.0 Build 23522
	-	AppDynamics Controller 20.10.0 Build 2464
	-	AppDynamics Events Service 4.5.2.0 Build 20640
	-	AppDynamics EUM Server 20.10.0 Build 32035
-	Docker 19.03.13 CE
...
-	Amazon AWS CLI 2.0.54 (command-line interface)
-	Amazon AWS EC2 Instance Metadata Query Tool (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.29.2 (command-line interface)
...
-	Python 3.6.8
	-	Pip 20.2.3
-	Serverless Framework CLI 2.4.0
-	VIM - Vi IMproved 8.2
