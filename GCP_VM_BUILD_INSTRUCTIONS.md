...
-	Amazon AWS CLI 2.0.33 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.0.33](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
1.	Install [AWS CLI 2.0.33](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
-	Ansible 2.9.9
-	AppDynamics Enterprise Console 20.7.1 Build 22912
	-	AppDynamics Controller 20.7.1 Build 2905
	-	AppDynamics Events Service 4.5.2.0 Build 20634
-	Docker 19.03.12 CE
	-	Docker Bash Completion
	-	Docker Compose 1.26.2
	-	Docker Compose Bash Completion
-	Java SE JDK 8 Update 262 (Amazon Corretto 8)
...
-	jq 1.6 (command-line JSON processor)
-	Node.js JavaScript runtime v12.18.2 (Latest LTS Version)
...
-	Python 3.6.8
	-	Pip 20.1.1
-	Serverless Framework CLI 1.75.1
-	VIM - Vi IMproved 8.2
