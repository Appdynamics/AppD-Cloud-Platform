...
-	Amazon AWS CLI 2.0.30 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.0.30](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
1.	Install [AWS CLI 2.0.30](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
-	Ansible 2.9.9
-	AppDynamics Enterprise Console 20.6.3 Build 22636
	-	AppDynamics Controller 20.6.5 Build 2337
...
-	npm JavaScript Package Manager for Node.js 6.14.6
-	nvm (Node Version Manager) bash script 0.35.3
-	Python 2.7.5
	-	Pip 20.1.1
-	Python 3.6.8
	-	Pip 20.1.1
-	Serverless Framework CLI 1.74.1
-	VIM - Vi IMproved 8.2
